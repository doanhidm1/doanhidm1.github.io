...
以下の2つのXMLファイルのapp\_name要素を変更します。
...
krkrz/android/app/src/product/res/以下のmipmap-xxxディレクトリにic\_launcher.pngと言う名前で置きます。
...
[Android版でのプラグインの利用](../android_plugins/index)を参照してください。
